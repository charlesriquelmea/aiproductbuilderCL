  ...
  return (
    <>
      ...
      <main className="flex-1 lg:ml-72 min-h-screen">
        ...
        <header className="h-16 border-b border-[#27272a] bg-[#0a0a0a]/80 backdrop-blur-md sticky top-0 z-30 px-6 sm:px-10 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-600 to-purple-800 flex items-center justify-center text-xs font-bold text-white">
                CM
              </div>
            </div>
          </div>
        ...
        {/* Footer del Portal */}
        <footer className="mt-20 border-t border-[#27272a] py-8 px-6 sm:px-10 flex flex-col sm:flex-row items-center justify-between gap-4 text-[#71717a]">
